...
/**
 * HazelcastServiceInstance class
 */
public class DeployerServiceInstance extends ServiceInstance {

    private String hazelcastIPAddress;
    private InetAddress hazelcastInetAddress;
    private int hazelcastPort;

    public DeployerServiceInstance(CreateServiceInstanceRequest request) {
        super(request);
    }
