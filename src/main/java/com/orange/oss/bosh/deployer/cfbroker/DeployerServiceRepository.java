 ...
 */
public final class DeployerServiceRepository {

    private static final DeployerServiceRepository INSTANCE = new DeployerServiceRepository();
    ...
    private DeployerServiceRepository() {
    ...
    public static DeployerServiceRepository getInstance() {
        return INSTANCE;
    }
